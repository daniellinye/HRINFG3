...
INSERT INTO question (id, name, category_id, type)
  ...
  VALUES  (1, 'Welke bar in Rotterdam werd in 2009 de beste bar ter wereld benoemd?', 1, 'multiple_choice'),
          ...
          (215, 'Waar dankt Rotterdam zijn naam aan?', 3, 'open'),
          (216, 'Wat is het enigste overgebleven middeleeuws gebouw in de binnenstad van Rotterdam?', 3, 'open'),
          (217, 'Wie is de nachtburgemeester van Rotterdam?', 3, 'open'),
          (218, 'Was de eerste metrolijn in Nederland in Rotterdam geopend?', 3, 'open'),
          (219, 'Waar stond vroeger de wijk Katendrecht om bekend?', 3, 'open'),
          (220, 'Wanneer is diergaarde Blijdorp geopend?', 3, 'open'),
          (221, 'Wat is de offici�le naam van de koopgoot?', 3, 'open'),
          (222, 'Welk gebouw (gebouwd in 1957) stond symbool voor de wederopbouw van de stad?', 3, 'open'),
          (223, 'Hoeveel joden woonden er in Rotterdam voor de Tweede Wereldoorlog?', 3, 'open'),
          (224, 'Wat was tijdens de Tweede Wereldoorlog de enige weg naar het centrum die de Duitsers probeerden te bereiken?', 3, 'open'),
          (225, 'Rotterdam was tot 1870 een opslag haven, welke producten werden er onder ander opgeslagen?', 3, 'open'),
          (226, 'Na 1872 is de stad Rotterdam snel groot geworden, Pieter Caland had een plan om Rotterdam met de zee te verbinden. Hoe noemde hij die verbinding?', 3, 'open'),
          (227, 'Door welke architect(en) is de Euromast ontworpen?', 3, 'open'),
          (228, 'In welk jaar heeft Rotterdam stadsrechten gekregen?', 3, 'open'),
          (229, 'Hoe heette de haven van Rotterdam oorspronkelijk tijdens zijn ontstaan?', 3, 'open'),
