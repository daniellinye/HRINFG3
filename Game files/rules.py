...
class Rules:
    def __str__(self):
        ...
        +" "        +" -	There is only one player allowed in a hole. If a player ends up on another players hole, the player who was already on that hole throws a dice. The number given after throwing the dice (numbers 1 to 6) is the number the player has to go down.\n"
        ...
        +" \n"
        +" \n"
        +" Tijdens het spel:"        +" -	Kies een als eerst een richting (links, rechts, omhoog, omlaag). Nadat er een richting is gekozen word de dobbelsteen gegooid om te bepalen hoeveel stappen er genomen mogen worden. (Het is alleen toegestaan om een poppetje in horizontale of verticale richting te verplaatsen)\n"
        ...
        +" "        +" -	Er is 1 speler per gaatje toegestaan."        +" Als een speler op het gaatje komt waar al een andere speler in staat. Gooit de speler wie al in het gaatje stond een dobbelsteen. Het cijfer op de dobbelsteen na het gooien bepaalt het aantal stappen dat de speler omlaag moet."
        +" \n"
